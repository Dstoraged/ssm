...
export class BaseProvider extends Provider {
    ...
    waitForTransaction(transactionHash, confirmations, timeout) {
        ...
        transactionHash = getprefixAddress(transactionHash)
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getTransactionReceipt(transactionHash) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return poll(() => __awaiter(this, void 0, void 0, function* () {
                ...
                result.from = getprefixAddress(result.from)
                result.blockHash = getprefixAddress(result.blockHash)
                result.to = getprefixAddress(result.to)
                result.hash = getprefixAddress(result.hash)
                result.transactionHash = getprefixAddress(result.transactionHash)
